...
| HIGH | Error Handling | 4 rules | Prevents poor user experiences |
...
- `err-data-first-status-check` — Check data before error status to preserve UI during background refetch failures
