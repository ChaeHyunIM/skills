...
argument-hint: <issue-number> [effort] [--codex-model model]
---
...
3. [Claude에서 리뷰 실행하기](../../../agents/skills/agent-loop/review-round/references/claude-runtime.md)에 따라 두 리뷰어를 실행하고 모두 끝날 때까지 기다린다. 같은 실행을 두 번 시작하지 않는다.
